...
for i=1:12
    ...
    TF_Im_Todas(:,:,i)=(fftshift(fft2(cubo2(:,:,i)))); % Transformada de Fourier de todas las imágenes a tratar.
...
ki=[ norm(A(1,:)) norm(A(2,:)) norm(A(3,:)) norm(A(4,:)) ]*(1/Lx); %Vector con frec. de cada patrón
...
for l=1:3
    %Determinación de la fase del patrón
